...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIwMDExNDE0NDE1OTEwOTM5MDQ=";
...
<body onload="init();">
	<form id="form" name="form" method="post" action="MENTOR_mentorProfile_Address.jsp?Address=<%=roadFullAddr%>" >
		<input type="hidden" id="confmKey" name="confmKey" value=""/>
		<input type="hidden" id="returnUrl" name="returnUrl" value=""/>
		<input type="hidden" id="resultType" name="resultType" value=""/>
		<input type="submit" onclick ="AddressAdd('<%=roadFullAddr%>');" value="제출하기">
	</form>
</body>
</html>