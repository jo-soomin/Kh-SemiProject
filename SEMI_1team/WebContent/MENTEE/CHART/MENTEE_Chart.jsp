...
<meta charset="UTF-8">
<title>멘티차트</title>
<link href="MENTEE/CHART/CSS/MENTEE_Chart.css?ver=7" rel="stylesheet" type="text/css"/>
...
<ul>
      ...
      <li><a href="MENTEE/CALENDAR/MENTEE_Exercise_plan.jsp">운동캘린더</a></li>
...
function viewMonth(month) {
   $.ajax({
      type: 'post',
      url: 'profile.do',
      data: 'command=getChartMonth&month=' + month,
      dataType: 'json',
      async:false,
